...
//                    Log.i(tag + i, content.substring(i, i + 3000));
...
//        Log.i(tag, content);
     ...
     * @param content
     */
    private static void toastUrl(String content) {
//        if (!TextUtils.isEmpty(content) && content.contains("http://")){
//            int start = content.indexOf("http://");
//            String endStr = ".com";
//            int end = content.indexOf(endStr) + endStr.length();
//            String toastStr = String.format("%s\n%s",content.substring(start,end),content);
//            T.make(toastStr, ShineApplication.context);
//        }
    }
